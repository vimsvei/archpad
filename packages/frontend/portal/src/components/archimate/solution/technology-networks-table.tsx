...
import { removeTechnologyNetwork } from "@/store/slices/solution-edit-slice"
...
export function TechnologyNetworksTable({
  solutionId: _solutionId,
  solutionName,
  onAddExisting,
}: TechnologyNetworksTableProps) {
  ...
  return (
    <RelatedItemsMapTab<RelatedItem>
      ...
      emptyState={{ componentName: solutionName, itemTypeKey: "networks" }}
    />
  )
}