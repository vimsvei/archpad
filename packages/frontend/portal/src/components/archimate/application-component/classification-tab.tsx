...
export function ClassificationTab({ t, isSaving }: ClassificationTabProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="architecture-style">{t("directory.architecture.style")}</Label>
              <Select
          ...
          <div className="flex flex-col gap-4">
            {/* Critical Level */}
            <div className="grid gap-2">
              <Label htmlFor="critical-level">{t("directory.critical.level")}</Label>
              <Select
            ...
            {/* Failover Type */}
            <div className="grid gap-2">
              <Label htmlFor="failover-type">{t("directory.failover.type")}</Label>
              <Select
            ...
            {/* Recovery Time */}
            <div className="grid gap-2">
              <Label htmlFor="recovery-time">{t("directory.recovery.time")}</Label>
              <Select
            ...
            {/* Redundancy Type */}
            <div className="grid gap-2">
              <Label htmlFor="redundancy-type">{t("directory.redundancy.type")}</Label>
              <Select
            ...
            {/* Monitoring Level */}
            <div className="grid gap-2">
              <Label htmlFor="monitoring-level">{t("directory.monitoring.level")}</Label>
              <Select
            ...
            {/* Scaling Type */}
            <div className="grid gap-2">
              <Label htmlFor="scaling-type">{t("directory.scaling.type")}</Label>
              <Select
