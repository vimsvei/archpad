...
const NavCollapse = ({ menu, level, parentId }) => {
  ...
  const menuIcon = menu.icon ? (
    <Icon
      ...
      style={{ color: isSelected ? theme.palette.secondary[900] : theme.palette.text.primary }}
    ...
    <FiberManualRecordIcon
      sx={{
        ...
        color: isSelected ? theme.palette.secondary[900] : theme.palette.text.primary,
  ...
  const iconSelectedColor = theme.palette.mode === 'dark' && drawerOpen ? 'text.primary' : 'secondary[900]';
            ...
            {(drawerOpen || (!drawerOpen && level !== 1)) && (
              <ListItemText
                primary={
                  ...
                  //   {menu.title}
                  // </Typography>
                  <Typography variant={isSelected ? 'subtitle1' : 'body1'} color="inherit" sx={{ my: 'auto' }}>
                {menu.title}
                  </Typography>
                }
                secondary={
          ...
          >
            ...
            <ListItemText
              primary={
                ...
                //   {menu.title}
                // </Typography>
                <Typography variant={isSelected ? 'subtitle1' : 'body1'} color={theme.palette.secondary[900]} sx={{ my: 'auto' }}>
              {menu.title}
                </Typography>
              }
            />
